...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
      ...
      {/* Header - Show on all pages but adjust z-index for MyAccount */}
      <header className={`bg-white/80 backdrop-blur-xl border-b border-green-100 top-0 ${
        isMyAccountPage ? 'relative z-[9999]' : 'relative z-50'
      }`}>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                ...
                <SheetContent 
                  side="right" 
                  className={`w-80 ${isMyAccountPage ? 'z-[10000]' : 'z-[1000]'}`}
                >
